...
//
// This module is PURE (no network, no React) and is mirrored verbatim from the
// server's utils/slots.js, so the grid a patient taps and the grid the server
// validates against can never drift apart. Change one, change the other.
// ---------------------------------------------------------------------------
